...
$(function () {
    ...
    $(document).on("click", function (e) {
        ...
        // products tabs
        if ($target.is('.products__category')) {

            const $productsSection = $target.closest('.products');
            $productsSection.find('.products__category').removeClass('active');

            $target.addClass('active');

            const tabIndex = $target.closest('.nav-slider__item').index();

            const $contentBlocks = $productsSection.find('.products__content-block');

            $contentBlocks.removeClass('active');
            $contentBlocks.eq(tabIndex).addClass('active');
        }
    ...
    if ($('.products__content-block').length) {
        $('.products__content-block').each(function () {

            const currentSlider = $(this).find('.products__slider');
            const prevButton = $(this).find('.products__prev');
            const nextButton = $(this).find('.products__next');
